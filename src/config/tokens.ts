...
export const TOKEN_CONFIG = {
  ...
  // URLs de WebSocket para las dos balanzas
  WEBSOCKET_URLS: {
    BALANZA_UNO: "wss://balanzas-backend-develop-391235381605.us-central1.run.app/websocket/balanza-uno",
    BALANZA_DOS: "wss://balanzas-backend-develop-391235381605.us-central1.run.app/websocket/balanza-dos"
  },
...
// Función para obtener la URL de WebSocket según el endpoint
export const getWebSocketUrl = (endpoint: 'balanza-uno' | 'balanza-dos') => {
  return endpoint === 'balanza-uno' 
    ? TOKEN_CONFIG.WEBSOCKET_URLS.BALANZA_UNO 
    : TOKEN_CONFIG.WEBSOCKET_URLS.BALANZA_DOS;
};